...
if (!Object.getOwnPropertyDescriptor(Module["ready"], "_FMOD_JS_MixFunction")) {
 Object.defineProperty(Module["ready"], "_FMOD_JS_MixFunction", {
  configurable: true,
  get: function() {
   abort("You are getting _FMOD_JS_MixFunction on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_FMOD_JS_MixFunction", {
  configurable: true,
  set: function() {
   abort("You are setting _FMOD_JS_MixFunction on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}

if (!Object.getOwnPropertyDescriptor(Module["ready"], "_FMOD_JS_MixerSlowpathFunction")) {
 Object.defineProperty(Module["ready"], "_FMOD_JS_MixerSlowpathFunction", {
  configurable: true,
  get: function() {
   abort("You are getting _FMOD_JS_MixerSlowpathFunction on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_FMOD_JS_MixerSlowpathFunction", {
  configurable: true,
  set: function() {
   abort("You are setting _FMOD_JS_MixerSlowpathFunction on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}

if (!Object.getOwnPropertyDescriptor(Module["ready"], "_FMOD_JS_MixerFastpathFunction")) {
 Object.defineProperty(Module["ready"], "_FMOD_JS_MixerFastpathFunction", {
  configurable: true,
  get: function() {
   abort("You are getting _FMOD_JS_MixerFastpathFunction on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_FMOD_JS_MixerFastpathFunction", {
  configurable: true,
  set: function() {
   abort("You are setting _FMOD_JS_MixerFastpathFunction on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}
...
var ASM_CONSTS = {
 ...
 5589398: function($0, $1, $2, $3) {
  var data = HEAPF32.subarray($0 / 4 >>> 0, $0 / 4 + $2 * $3 >>> 0);
 ...
 5598018: function($0, $1, $2) {
  const buffer = $0;
  const bufferLength = $1;
  const speakerModeChannels = $2;
  var data = HEAPF32.subarray(buffer / 4 >>> 0, buffer / 4 + bufferLength * speakerModeChannels >>> 0);
...
var dynCall_vijiiiiiiiiiiiiiiiiiii = Module["dynCall_vijiiiiiiiiiiiiiiiiiii"] = createExportWrapper("dynCall_vijiiiiiiiiiiiiiiiiiii");
